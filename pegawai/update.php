            ...
            ?>
                <form class="form-horizontal"  method="post" action="edit_skpd.php" onkeypress="return disableEnterKey(event)">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="tgl_kembali" id="idtxt" class="form-control" type="date" value="<?php echo $row['tgl_kembali']; ?>">
                        </div>
                        <div class="col-lg-0">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="data.php" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Back</a>
                        </div>
                    </div>
                </form>
            <?php } ?>
