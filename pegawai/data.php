...
if(($_SESSION['eskpd']) !== 'pegawai' AND ($_SESSION['eskpd']) !== 'kepala_cabang'){
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="data.php"><em class="fa fa-calendar">&nbsp;</em> Data SKPD</a></li>
				...
				<div class="panel-heading">
					<div class="row">
						<div class="col col-xs-6">
							<h3 class="panel-title">Data SKPD</h3>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<table class="table table-striped table-bordered table-list">
						...
						<tbody>
							<?php
								include '../dbconfig.php';
								$tampil = mysqli_query($connect, "SELECT * FROM skpd s JOIN pegawai p JOIN kantor k ON s.npp1 = p.npp AND s.id_kantor = k.id_kantor order by s.waktu desc");
							$no=1;
							foreach ($tampil as $row){
								...
								<td align="center">
								<a href="update.php?edit=<?php echo strtotime($row['waktu']); ?>" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
								<a data-href="delete_skpd.php?hapus=<?php echo strtotime($row['waktu']); ?>" data-toggle='modal' data-target='#konfirmasi_hapus' class="btn btn-danger"><em class="fa fa-trash"></em></a>
								<a href="cetak.php?cetak=<?php echo strtotime($row['waktu']); ?>" class="btn btn-success"><em class="fa fa-print"></em></a>
								</td>
								</tr><?php
								$no++; 
							}?>
