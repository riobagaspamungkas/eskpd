...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="data.php"><em class="fa fa-calendar">&nbsp;</em> Data SKPD</a></li>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="agileinfo_sign">Silahkan masukkan pegawai</h4>
			</div>
              <div class="panel-body">
                <table class="table table-striped table-bordered table-list">
                  	<thead>
	                    ...
	                    <?php
	                    include '../dbconfig.php';
	                    $tampil = mysqli_query($connect, "SELECT * FROM pegawai order by npp asc");
	                    $no=1;
	                    foreach ($tampil as $data){
	                    	...
	                    	<td>".$data['jabatan']."</td> " ?>
	                    	<td align="center">
	                    		<button type="button" class="btn btn-primary" data-dismiss="modal"><em class="fa fa-pencil">Pilih</em></button>
	                        </td>
