...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="col-sm-9 col-sm-offset-1 col-lg-10 col-lg-offset-1 main">
			...
			<form class="form-horizontal"  method="post" action="t_kendaraan.php" onkeypress="return disableEnterKey(event)">
				<div class="form-group">
					<label for="jenis_kendaraan" class="col-lg-3 control-label">Jenis Kendaraan:</label>
					<div class="col-lg-8">
						<input name="jenis_kendaraan" class="form-control" type="text" value="" placeholder="Masukkan jenis kendaraan" required="">
					</div>
				</div>
				<div class="form-group">
