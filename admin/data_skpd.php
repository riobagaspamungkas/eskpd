...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="data_skpd.php"><em class="fa fa-calendar">&nbsp;</em> Data SKPD</a></li>
					...
					<table class="table table-striped table-bordered table-list">
						...
						<tbody>
							...
							foreach ($tampil as $row){
								...
								<td align="center">
								<a href="update_skpd.php?edit=<?php echo strtotime($row['waktu']); ?>" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
