	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Tambah Kantor</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="col-sm-9 col-sm-offset-1 col-lg-10 col-lg-offset-1 main">
			...
			<form class="form-horizontal"  method="post" action="t_kantor.php" onkeypress="return disableEnterKey(event)">
				<div class="form-group">
					<label for="nama_kantor" class="col-lg-3 control-label">Pejabat yang Memerintah:</label>
					<div class="col-lg-8">
						<input name="nama_kantor" class="form-control" type="text" value="" placeholder="Masukkan nama kantor cabang" required="">
					</div>
				</div>
				<div class="form-group">
					<label for="singkatan" class="col-lg-3 control-label">Pejabat yang Menandatangani:</label>
					<div class="col-lg-8">
						<input name="singkatan" class="form-control" type="text" value="" placeholder="Masukkan nama kantor cabang" required="">
					</div>
				</div>
				<div class="form-group">
					<label for="npp" class="col-lg-3 control-label" >Nama Kepala Kantor Cabang:</label>
					<div class="col-md-8">
						<select name="npp" class="form-control">
							<option value="">Silahkan pilih</option>
							<?php 
							$q = mysqli_query($connect, 'SELECT * FROM pegawai WHERE hak_akses = "kepala_cabang" ORDER BY npp asc');
							foreach ($q as $p) {
								echo "<option value=$p[npp]>$p[nama_pegawai]</option>";
							} ?>
						</select>
					</div>
				</div>
