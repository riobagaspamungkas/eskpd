...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        $data = mysqli_query($connect, "SELECT * FROM kendaraan WHERE id_kendaraan = $id_kendaraan");
		while($row = mysqli_fetch_array($data)){
        ?>
			<form class="form-horizontal"  method="post" action="edit_kendaraan.php" onkeypress="return disableEnterKey(event)">
				<div class="form-group">
					<label for="jenis_kendaraan" class="col-lg-3 control-label">Jenis Kendaraan:</label>
					<div class="col-lg-8">
						<input type="hidden" name="get_id_kendaraan" value="<?php echo $row['id_kendaraan']; ?>">
						<input name="jenis_kendaraan" class="form-control" type="text" value="<?php echo $row['jenis_kendaraan']; ?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						...
						<a href="data_kendaraan.php" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Back</a>
				</div>
			</form>
        <?php } ?>
		</div>
