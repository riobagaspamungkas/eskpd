...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="data_pegawai.php"><em class="fa fa-users">&nbsp;</em> Data Pegawai</a></li>
				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-3 col-md-3 col-lg-3">
							<a href="tambah_pegawai.php" class="btn btn-default"><em class="fa fa-plus"></em> Tambah Pegawai</a>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<table class="table table-striped table-bordered table-list">
						...
						<tbody>
							<?php $no=1;
								include '../dbconfig.php';
								$tampil = mysqli_query($connect, "SELECT * FROM pegawai order by npp desc");
							$no=1;
							foreach ($tampil as $row){
								...
								<td>".$row['jabatan']."</td> " ?>
								<td align="center">
								<a href="update_pegawai.php?npp=<?php echo $row['npp']; ?>" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
								<a data-href="delete_pegawai.php?npp=<?php echo $row['npp']; ?>" data-toggle='modal' data-target='#konfirmasi_hapus' class="btn btn-danger"><em class="fa fa-trash"></em></a>
								</td>
								</tr><?php
								$no++;
							}?>
