...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="data_kantor.php"><em class="fa fa-hospital-o">&nbsp;</em> Data Kepala Cabang</a></li>
				...
				<div class="panel-heading">
					<div class="row">
						<div class="col col-xs-6">
							<h3 class="panel-title">Data Kantor</h3>
						</div>
						<div class="col-xs-3 col-md-3 col-lg-3">
							<a href="tambah_kantor.php" class="btn btn-default"><em class="fa fa-plus"></em> Tambah Kantor</a>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<table class="table table-striped table-bordered table-list">
						...
						<tbody>
							<?php $no=1;
								include '../dbconfig.php';
								$tampil = mysqli_query($connect, "SELECT * FROM pegawai p JOIN kantor k ON p.npp = k.knpp order by k.id_kantor desc");
							foreach ($tampil as $row){
								...
								<td align="center">
								<a href="update_kantor.php?id_kantor=<?php echo $row['id_kantor']; ?>" class="btn btn-primary"><em class="fa fa-pencil"></em></a>
								<a data-href="delete_kantor.php?id_kantor=<?php echo $row['id_kantor']; ?>" data-toggle='modal' data-target='#konfirmasi_hapus' class="btn btn-danger"><em class="fa fa-trash"></em></a>
								</td>
								</tr><?php
								$no++;
							}?>
